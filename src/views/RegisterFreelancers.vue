<template>
  <div class="about">
    <v-img class="rounded-xl" height="100vh" src="../assets/hero-bg.jpg">
      <v-container class="fill-height">
        <v-row class="fill-height" align="center">
          <v-col cols="12" md="6">
            <h1 class="white--text text-capitalize display-4 hidden-sm-and-down font-weight-bold">Register Now</h1>
						<h1 class="white--text text-capitalize display-1 hidden-md-and-up font-weight-bold">Register Now</h1>
